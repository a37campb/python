% Euler’s method
%
% Copy the description from 3.1 here
%
% Parameters
% ==========
...
function [ t_out, y_out ] = euler( f, t_rng, y0, n )
    ...
    %{
    This function will determine the difference in the actual value, and 
    the approximated value. Then it will determine the vector of the evenly
    spaced n points between, to then fill a zero vector by finding the 
    slope of f. 
    %}
